  ...
  return (
    <main className="flex flex-col justify-center items-center">
      ...
      <form className="mt-12 max-w-2xl mx-auto" onSubmit={handleSubmit}>
        ...
        <input className="px-4 py-2 mb-6 text-gray-800 border-2 w-72 border-blue-500 outline-none focus:bg-gray-100" name="email" type="email" />
        <br />
        <div className="flex justify-center items-center">
          <button className="focus:outline-none focus:ring focus:border-blue-800 px-6 py-2 rounded-xl envy-blue-bg text-blue-50 hover:bg-blue-800 font-semibold">Log in</button>
        </div>
      </form>
    </main>
  )
